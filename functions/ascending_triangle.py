...
# price values. Then, it checks whether the close prices of each data point fall within the bounds of the 
# upper and lower trendlines, and assigns a value of 1 where the condition is true and 0 where it is false. 
